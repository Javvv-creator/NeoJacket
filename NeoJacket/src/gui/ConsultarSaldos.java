    ...
    class FondoPanel extends JPanel {
        ...
        private void crearSidebar(JPanel panel) {
            ...
            for (String texto : opciones) {
                ...
                if (texto.equals("Bancos Conectados")) btn.addActionListener(e -> { new BancosConectados().setVisible(true); dispose(); });
        ...
        private void crearContenido() {
            ...
            // BARRA SUPERIOR RE-ESTILIZADA SIN TEXTOS SUPERPUESTOS
            ...
            // MARCO CONTENEDOR PARA FILTRO (COMBOBOX + BOTÓN)
            JPanel marcoFiltro = new JPanel() {
                @Override
                protected void paintComponent(Graphics g) {
                    Graphics2D g2 = (Graphics2D) g.create();
                    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                    g2.setColor(new Color(251, 232, 138, 40)); // Borde amarillo sutil
                    g2.setStroke(new BasicStroke(1.2f));
                    g2.drawRoundRect(0, 0, getWidth() - 1, getHeight() - 1, 15, 15);
                    g2.dispose();
                }
            };
            marcoFiltro.setBounds(40, 95, 1220, 90);
            ...
            lblSelecciona.setBounds(30, 10, 200, 25);
            marcoFiltro.add(lblSelecciona);

            // COMBOBOX ESTILO PREMIUM CON HOVER AMARILLO
            ...
            cbBancos.setBounds(30, 38, 350, 38);
            ...
            // Customización UI del Combobox (Remover flecha nativa fea y cambiar listas)
            ...
            // ListCellRenderer para aplicar efectos hover dentro de la lista desplegable
            ...
            // Botón consultar integrado simétricamente
            BotonNeo btnConsultar = new BotonNeo("ⓘ Consultar", amarillo, amarilloHover);
            btnConsultar.setForeground(Color.BLACK);
            btnConsultar.setBounds(400, 38, 160, 38);
            ...
            // Centrar celdas de la tabla para estética limpia
            ...
            // Lógica funcional intacta de tu base de datos
