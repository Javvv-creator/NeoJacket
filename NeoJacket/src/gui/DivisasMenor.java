...
public class DivisasMenor extends javax.swing.JFrame {
    ...
    public DivisasMenor() { this(null); }

    public DivisasMenor(Integer idMenor) {
            ...
            try {
                ...
                javax.swing.SwingUtilities.invokeLater(() -> {
                    ...
                    for (String moneda : monedas) {
                        modeloTabla.addRow(new Object[]{"GTQ → " + moneda, tasas.getOrDefault(moneda, "N/A"), fecha});
                    }
                });
            } catch (Exception e) {
                javax.swing.SwingUtilities.invokeLater(() -> {
    ...
    class FondoPanel extends JPanel {
        public FondoPanel() { setLayout(null); crearSidebar(); crearContenido(); }
        ...
        private void crearSidebar() {
            ...
            // Botón regresar al DashboardMenor
        ...
        private void crearContenido() {
            ...
            tabla.setDefaultRenderer(Object.class, new javax.swing.table.DefaultTableCellRenderer() {
                @Override public Component getTableCellRendererComponent(javax.swing.JTable t, Object val, boolean sel, boolean foc, int row, int col) {
                    super.getTableCellRendererComponent(t, val, sel, foc, row, col);
                    setForeground(Color.WHITE);
                    setBackground(sel ? new Color(94, 116, 73, 150) : row % 2 == 0 ? new Color(20, 32, 29) : new Color(30, 46, 42));
            ...
            lblMonto.setForeground(Color.WHITE); lblMonto.setFont(textoInputs);
            lblMonto.setBounds(20, 55, 140, 20); pCalc.add(lblMonto);

            JTextFieldRedondeado txtMonto = new JTextFieldRedondeado();
            txtMonto.setBounds(165, 48, 220, 38); pCalc.add(txtMonto);

            JLabel lblMoneda = new JLabel("Divisa destino:");
            lblMoneda.setForeground(Color.WHITE); lblMoneda.setFont(textoInputs);
            lblMoneda.setBounds(420, 55, 130, 20); pCalc.add(lblMoneda);
            ...
            lblResultado.setBounds(20, 140, 900, 28); pCalc.add(lblResultado);
                ...
                try {
                    ...
                    for (int i = 0; i < modeloTabla.getRowCount(); i++) {
                        ...
                        if (par != null && par.contains(monedaSel)) {
                            ...
                            lblResultado.setText(String.format("Q %.2f GTQ  =  %.4f %s", monto, monto * tasa, monedaSel));
                            return;
                        }
                    }
                    lblResultado.setText("Tasa no disponible. Recarga primero.");
                } catch (NumberFormatException ex) { lblResultado.setText("Ingresa un monto numérico válido."); }
            });
            pCalc.add(btnConvertir);
        }

        @Override protected void paintComponent(Graphics g) { super.paintComponent(g); g.drawImage(fondo, 0, 0, getWidth(), getHeight(), this); }
    }
    ...
    class JTextFieldRedondeado extends JTextField {
        public JTextFieldRedondeado() { setOpaque(false); setBorder(BorderFactory.createEmptyBorder(5, 15, 5, 15)); }
        @Override protected void paintComponent(Graphics g) {
            Graphics2D g2 = (Graphics2D) g.create();
            g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
    ...
    public static void main(String args[]) { SwingUtilities.invokeLater(() -> new DivisasMenor().setVisible(true)); }
}