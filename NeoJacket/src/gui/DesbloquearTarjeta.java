...
public class DesbloquearTarjeta extends JFrame {
    ...
    class FondoPanel extends JPanel {
        ...
        private void crearContenido() {
            ...
            JLabel titulo = new JLabel("Desbloquear Tarjeta");
            ...
            lblMotivo.setBounds(30, 400, 300, 25);
            panel.add(lblMotivo);

            RoundedTextField txtMotivo = new RoundedTextField(20);
            txtMotivo.setBounds(30, 430, 520, 40);
            panel.add(txtMotivo);
            ...
            btnCancelar.setBounds(30, 690, 200, 50);
